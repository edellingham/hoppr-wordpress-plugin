...
class Hoppr {
    ...
    public static function uninstall() {
        ...
        // Use proper prepared statements for table names - WordPress doesn't support %i placeholder for table names
        // So we need to validate table names are safe (they are generated by WordPress with known prefixes)
        $safe_tables = array(
        ...
        // Validate that our table names match expected pattern and execute safely
        foreach (array($qr_codes_table, $analytics_table, $redirects_table) as $table) {
    ...
    /**
     * Get the redirects handler instance.
     * 
     * @return Hoppr_Redirects The redirects handler instance.
     */
    ...
    /**
     * Get the analytics handler instance.
     * 
     * @return Hoppr_Analytics The analytics handler instance.
     */
    ...
    /**
     * Get the QR codes handler instance.
     * 
     * @return Hoppr_QR_Codes The QR codes handler instance.
     */
     ...
     * 
     * @return Hoppr_Settings The settings handler instance.
     */
